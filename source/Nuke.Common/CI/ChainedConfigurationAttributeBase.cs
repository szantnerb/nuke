...
namespace Nuke.Common.CI
{
    ...
    public abstract class ChainedConfigurationAttributeBase : ConfigurationAttributeBase
    {
        ...
        protected IEnumerable<string> GetInvokedTargets(ExecutableTarget executableTarget, IReadOnlyCollection<ExecutableTarget> relevantTargets)
        {
            ...
            return ExecutionPlanner.GetExecutionPlan(invokedTargets, new[] { executableTarget.Name }).Select(x => x.Name);
        }
