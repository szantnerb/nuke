            ...
            IReadOnlyCollection<ExecutableTarget> executableTargets)
        {
            ...
            TextTasks.WriteAllText(
                new[]
                {
                    ...
                    "#",
                    "#     It is used to provide shell-completion via the global tool.",
                    "#     See: https://nuke.build/docs/running-builds/global-tool.html",
                    "#",
                    "#     It can be committed to VCS when moved to the root directory.",
                    "#",
                    "# </auto-generated>",
                    "# ------------------------------------------------------------------------------",
                    SerializationTasks.YamlSerialize(completionItems)
                }.JoinNewLine(),
                GetCompletionFile(NukeBuild.RootDirectory));
